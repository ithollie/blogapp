...
if($conn->connect_error) {
    ...
    header('location: loginFailed.php');
            ...
            $postss   =  mysqli_query($conn,   "SELECT *  FROM `blogs`") or die($conn->error);
  ...
  <body>
	...
	<div id="wrapper"  style="height:; position:">
        ...
        <div id="" style="width:100%; height:20PX;background-color:;">
            ...
            <div id="welcome" ><h1 id="firstname" style="font-size:31px;color:;font-weight:700;padding-top:1px">Admin  Login was successful:  <?php  echo  $firstname ." ". $lastname ?>  </h1></div>
  		</div>
  		    
  		    <br />
  		    
  		    <div id="current" style="padding-top: 2px; padding-bottom:101px; text-align:center; width:100%; height:10%; background-color:#d0d0d0">
                ...
                <h1 style="color:black; font-size:20px;font-weight:700;padding-top:1px">Current members</h1>
                    ...
                    <?php while($row = mysqli_fetch_array($alls, MYSQLI_ASSOC)){ ?>
                        ...
                        <div id="" style="width:100%; height:200px;background-color:red;">
                            
                                  <div id="te" style="background-color:; padding-top:0px;position:relative;background:white;padding-top: 1px;">
                                          
                                          <ul>

                                                <li style="color:black;"><?php  echo $row['firstname']; ?></li>
                                          </ul>
                          ...
                          <div id="" style="width:100%; height:57px;background-color:white;padding-top:0px">
                              <div id="te" style="padding-top:0px;position:relative;background:;padding-top: 0px;">
                                     <ul>
                                          ...
                                          <li id="commet" ><a class="waves-effect waves-light btn  teal" style="text-transform: lowercase;color:; text-decoration:none;background-color: yellow" href="comment.php?='".$row['id']."'"><i class="material-icons"></i>comment 0</a></li>
                                          ...
                                          <li ><a  data-key-key="<?php  echo   $row["id"] ?>" class="waves-effect waves-light btn  pink" style="text-transform: lowercase;color:white; text-decoration:none;background-color:red" href="updateform.php?='".$row['id']."'"><i class="material-icons"></i>Edit</a></li>
                                          <li id="like"><a class="waves-effect waves-light btn  teal" style="text-transform: lowercase;color:; text-decoration:none;background-color: yellow" ><i class="material-icons"></i>likes</a></li>
                                          <li id="dislike"><a class="waves-effect waves-light btn  teal" style="text-transform: lowercase;color:; text-decoration:none;background-color: yellow" ><i class="material-icons"></i>dislike</a></li>
          ...
          function likes(){
            ...
            for(let  v  =  0;  v <  likes_click.length;  v++){
                    ...
                    if(event.target.attributes[1].nodeValue != 0){
                      ...
                      xmlhttp.open("GET", "like.php?q='1'", true);
                      xmlhttp.send();
                ...
                if(event.target.attributes[1].nodeValue != 0){
                  ...
                  xmlhttp.onreadystatechange = function() {
                    ...
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        alert("You  have  disliked  the  post");
                  ...
                  xmlhttp.open("GET", "dislikes.php?q='2'", true);
                  xmlhttp.send();
