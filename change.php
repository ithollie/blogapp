...
if($_REQUEST["changePassword"] != null){
                ...
                <div class="col-sm-12 col-md-10 col-md-offset-1">
                  <form  id="loginForm"  action="login_process.php" method="post" role="form">
                    ...
                    <div class="form-group text-center">
                      <a style="color:white" href="admin.php"><strong>Admin</strong></a>&nbsp;|<a style="color:white" href="{{url_for('changePassword')}}"><strong>Forgot Password</strong></a>&nbsp;|&nbsp;<a style="color:white" href="#"><strong>Support</strong></a>|&nbsp;<a style="color:white" href="register.php"><strong>signup</strong></a>
                    </div>
