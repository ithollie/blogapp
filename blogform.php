...
$error_message   ="Create blog";

      
if($_REQUEST['error_message'] ===  "exist"){
    
    $error_message ="Blog  name  already exist please  change  the  name of  your blog";
}
...
<body style="background-color:#671636">
  <div id="titlelogin" style="width:100%; height:10%;background-color:#671636">
	...
	<div id="wrapper" style="background-color:#671636">
	   ...
	   <div id="" style="color:white; font-size:24px; font-weight:300"><h1 style="color:white;"><?php  echo  $error_message; ?></h1></div>
              ...
              <div class="col-sm-12 col-md-10 col-md-offset-1">
                <form  id="loginForm" action="blog_process.php" method="post" enctype ="multipart/form-data">
                  <div class="form-group input-group">
                    ...
                    <input style="border-radius: 10px;padding-left:12px;background-color:white" class="form-control" type="text" name="title" placeholder="title" value="" />
                  </div>
                  <div class="form-group input-group">
                    <span style="color:white" class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                  ...
                  <div class="form-group input-group">
                    ...
                    <textarea id="paragrph" style="width:30%; border-radius: 10px;padding-left:12px;background-color:white" class="form-control" type="text" cols="80" name="description" placeholder="Description"  value="hello" required /></textarea>
                  </div>
