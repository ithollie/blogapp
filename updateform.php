...
<body style="background-color:#671636">
  <div id="titlelogin" style="width:100%; height:10%;background-color:#671636;color:white">
    ...
    <div id="" style="margin:center">
        ...
        <h1 style="color:white; text-align:center;font-style:20px">Please  make   updates </h1>
            ...
            <div id="stt" data-key="<?php echo $title ?>" style="padding-top: 5px;width:60%; height:100%; background-color:; text-align:center;margin:auto">
				...
				<div class="container" style="background-color:">
                    ...
                    <div class="col-sm-12 col-md-10 col-md-offset-1">
                        <form  id="loginForm" action="update.php?id='<?php echo $id;  ?>'" method="post" enctype ="multipart/form-data">
                        ...
                        <div class="form-group input-group">
                            ...
                            <textarea id="paragraph"  style="width:30%; border-radius: 10px;padding-left:12px;background-color:white" class="form-control" type="text" cols="80" name="description" placeholder="discription "  ><?php  echo $discription;  ?></textarea>
                        </div>
